...
A Papers, Please type C++ game built using SFML
...
Animal passports approved score system  
Sound design  
...
Q key - Quit game (After end game)  
#### Mouse  
Right click to open stamp context window (Accept, decline)  
...
### References 
  ...
  Images - Adobe stock  
  Animals, passports, Ark icon, Heart icon, stamps  
    
  Sound - Soundsnap  

 [References](Data/References/References.docx)
